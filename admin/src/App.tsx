...
export default function App() {
  ...
  const [editingTouchGame, setEditingTouchGame] = useState<GameItem | null>(
    null,
  );
  ...
  const [updateGameTarget, setUpdateGameTarget] = useState<GameItem | null>(
    null,
  );
  ...
  const saveAdsConfig = async () => {
    try {
      ...
      if (res.ok) {
        setAdsSavedMsg(
          "✅ Ads Configuration saved & deployed live to mobile app!",
        );
  ...
  // Only the isolated preview adapter receives simulator commands.
      ...
      >
        ...
        >
          ...
          <nav style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
            {[
              ...
              { id: "preload", label: "Startup Preload", icon: Zap },
                  ...
                  (
                    {
                      ...
                      upload: "games.upload",
                      update: "games.update",
                      gestures: "games.configure",
                      ads: "ads.configure",
                      preload: "games.configure",
                      simulator: "games.read",
                      feed: "feed.manage",
        ...
        >
          ...
          >
            <div>
              <h2 style={{ fontSize: "20px", fontWeight: "700" }}>
                ...
                {activeTab === "preload" &&
                  "Startup Preload Remote Configuration"}
              </h2>
            </div>
          ...
          <div style={{ padding: "32px", flex: 1 }}>
                  ...
                  {uploadSuccess && (
                    <div
                      style={{
                        ...
                        borderRadius: "10px",
                        color: uploadSuccess.startsWith("✨")
                          ? "#34d399"
                          : "#f87171",
                        fontSize: "13px",
                        display: "flex",
                    ...
                    >
                      ...
                      {!uploadSuccess.startsWith("✨") && (
                        ...
                        >
                          👉 Please check the 7-Point Verification Checklist on
                          the right to see which rule failed and fix your ZIP
                          file.
                        </span>
                      )}
                    </div>
                ...
                <div className="glass-panel" style={{ padding: "28px" }}>
                  ...
                  {uploading ? (
                    ...
                    >
                      ...
                      />
                      <p>
                        Upload a game package to run the automatic 7-point
                        validation audit.
                      </p>
                    </div>
                  )}
            ...
            {activeTab === "update" && (
              ...
              >
                <div className="glass-panel" style={{ padding: "28px" }}>
                  ...
                  >
                    Replace game code or release a new version for an existing
                    game without deleting its stats, ratings, or ID.
                  </p>
                      ...
                      >
                        ...
                        >
                          <img
                            src={
                              (updateGameTarget ||
                                selectedGame)!.thumbnailUrl.startsWith("http")
                                ? (updateGameTarget || selectedGame)!
                                    .thumbnailUrl
                                : `${API_BASE}${(updateGameTarget || selectedGame)!.thumbnailUrl}`
                            }
                            style={{
                              width: "100%",
                              height: "100%",
                        ...
                        <div>
                          <div style={{ fontWeight: 800, fontSize: "15px" }}>
                            {(updateGameTarget || selectedGame)!.title}
                          </div>
                          <div
                            style={{
                              fontSize: "12px",
                          ...
                          >
                            ...
                            >
                              {(updateGameTarget || selectedGame)!.id}
                            </span>{" "}
                            • Current:{" "}
                            <span style={{ color: "#34d399", fontWeight: 700 }}>
                              v
                              {(updateGameTarget || selectedGame)!.versions[0]
                                ?.version || "1.0.0"}
                            </span>
                          </div>
                          <div
                          ...
                          >
                            Last Updated:{" "}
                            {(updateGameTarget || selectedGame)!.updatedAt
                              ? new Date(
                                  (updateGameTarget || selectedGame)!
                                    .updatedAt!,
                                ).toLocaleString()
                  ...
                  >
                    ...
                    <div style={{ fontWeight: 700, fontSize: "15px" }}>
                      {updateGameTarget || selectedGame
                        ? `Upload New ZIP for "${(updateGameTarget || selectedGame)!.title}"`
                ...
                <div className="glass-panel" style={{ padding: "28px" }}>
                  ...
                  {uploading ? (
                    ...
                    >
                      ...
                      />
                      <p>
                        Select a game and drop a new build to inspect the update
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Activity size={18} color="#818cf8" /> Live Bridge
                      Protocol Stream
                    </h3>
                  ...
                  >
                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        sendSimulatorEvent(
                          nextMute ? "MUTE_AUDIO" : "UNMUTE_AUDIO",
                        );
                      }}
                  ...
                  >
                    {bridgeLogs.length === 0 ? (
                      ...
                      >
                        Interact with the device simulator to inspect live JSON
                        message envelopes.
                      </div>
                    ) : (
                      bridgeLogs.map((log) => (
              ...
              <div className="glass-panel" style={{ padding: "28px" }}>
                ...
                >
                  <div>
                    ...
                    <p style={{ fontSize: "13px", color: "var(--text-muted)" }}>
                      Control the exact order games appear in the mobile app
                      feed. <strong>Position #1</strong> is the first game shown
                      when the app opens. Newly uploaded games automatically
                      ...
                      >
                        ...
                        >
                          ...
                          <div>
                            ...
                            >
                              {game.slug} • Tags: {game.tags.join(", ")} •
                              Engine: {game.orientation}
                            </div>
                          </div>
                        </div>
                        ...
                        >
                          ...
                          <button
                            ...
                            onClick={() => reorderGame(game.id, "down")}
                            disabled={
                              idx === games.length - 1 || !can("feed.manage")
                            }
              ...
              >
                ...
                >
                  <div>
                    ...
                    >
                      Select which exact portion of the game screen blocks
                      ViewPager2 from scrolling. Outside this box, the user can
                      swipe to the next game freely!
                    </p>
                  </div>
                      ...
                      >
                        ...
                        >
                          ...
                          <button
                            ...
                            onClick={() =>
                              setTouchZonesList(
                                touchZonesList.filter((_, i) => i !== idx),
                              )
                            }
                          >
                            Remove
                ...
                <div className="glass-panel" style={{ padding: "32px" }}>
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        Control AdMob unit IDs, swipe frequency, and rewarded
                        hint rules live without app rebuilds.
                      </p>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    >
                      <div>
                        ...
                        >
                          Show full-screen ad after a certain number of game
                          swipes
                        </p>
                      </div>
                      <input
                    ...
                    >
                      ...
                      >
                        Controls how often full-screen ads appear when users
                        swipe between games. Recommended: 10.
                      </p>
                    </div>
                    ...
                    >
                      <div>
                        ...
                        >
                          Trigger interstitial ad when player completes levels
                    ...
                    >
                      ...
                      >
                        Show interstitial ad after player wins N levels (e.g.
                        every 2 wins or 3 wins, not on every single win).
                      </p>
                    </div>
                    ...
                    >
                      <div>
                        ...
                        >
                          Trigger interstitial ad when player loses or runs out
                          of lives/time
                        </p>
                      </div>
                      <input
                    ...
                    >
                      ...
                      >
                        Minimum time required between interstitial ads to
            ...
            {/* 8. STARTUP PRELOAD REMOTE CONFIG VIEW */}
            {activeTab === "preload" && (
              <div
                style={{
                  display: "grid",
              ...
              >
                ...
                <div className="glass-panel" style={{ padding: "32px" }}>
                  ...
                  {preloadSavedMsg && (
                    <div
                      style={{
                        ...
                        color: preloadSavedMsg.startsWith("✅")
                          ? "#34d399"
                          : "#f87171",
                      }}
                    >
                  ...
                  >
                    ...
                    >
                      While players enjoy the animated startup loading screen,
                      the mobile app automatically downloads this number of
                      games silently into local permanent device storage. Once
                      they finish the tutorial and swipe into the feed, these
                      games open <strong>instantly with zero latency</strong>.
                    </p>
                  </div>
                ...
                <div className="glass-panel" style={{ padding: "28px" }}>
                  ...
                  >
                    These first {preloadConfig.initialPreloadGameCount ?? 5}{" "}
                    games will download silently during launch:
                  </p>
