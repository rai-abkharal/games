...
export const CONFIG = {
  startScore: 301,
  aim: { cycle: 1.8, extent: 1.12, inputGuard: 0.14 },
  difficulty: {
...
export const RINGS = { bullseye: 0.045, bull: 0.105, tripleIn: 0.55, tripleOut: 0.615, doubleIn: 0.925, doubleOut: 1, numbers: 1.19 } as const;
